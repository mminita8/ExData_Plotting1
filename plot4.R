...
plot(feb2_consumption$TotalDate, as.numeric(feb2_consumption$Global_active_power), type = "l", pch = 19, xlab=" ", ylab = "Global active power")
plot(feb2_consumption$TotalDate, feb2_consumption$Voltage, type = "l", pch = 19, xlab="Datetime", ylab = "Voltaje")
...
plot(feb2_consumption$TotalDate, as.numeric(feb2_consumption$Global_reactive_power), type = "l", pch = 19, xlab="Datetime", ylab = "Global_reactive_power")
dev.off()
